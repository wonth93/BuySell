...
(2, 'Nissan GTR', 'Nissan', 'Good', 'So sad to let it go', 'https://example.com', 'https://example.com', 50000, 18000, 2004, '2018-02-14T08:06:00.000Z', true),
(2, 'Mini Cooper', 'Mini', 'Like New', 'Thanks for all the memories', 'https://example.com', 'https://example.com', 80000, 17000, 2005, '2018-02-15T08:06:00.000Z', true),
(2, 'Mitsubishi Lancer Evolution IX', 'Mitsubishi', 'New', 'It is my daily', 'https://example.com', 'https://example.com', 85000, 27000, 2006, '2018-02-16T08:06:00.000Z', true);
